void setupGUI(){
  ...
  sliders.add(controlP5.addSlider("count",1,1000,left,top+offset+0,len,15));
  offset += 30;
  sliders.add(controlP5.addSlider("noise",0,1000,left,top+offset+0,len,15));
  sliders.add(controlP5.addSlider("noiseStrength",0,1,left,top+offset+20,len,15));
  sliders.add(controlP5.addSlider("multiplier",-0.01,0.01,left,top+offset+40,len,15));
  offset += 70;
  ...
  for (Slider slider : sliders) {
    ...
    slider.getCaptionLabel().setColorBackground(0x99ffffff);
  }
}
