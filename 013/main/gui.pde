void setupGUI(){
  ...
  sliders.add(controlP5.addSlider("noiseStrength",0,10,left,top+offset+20,len,15));
  sliders.add(controlP5.addSlider("multiplier",-0.01,0.05,left,top+offset+40,len,15));
  offset += 70;
